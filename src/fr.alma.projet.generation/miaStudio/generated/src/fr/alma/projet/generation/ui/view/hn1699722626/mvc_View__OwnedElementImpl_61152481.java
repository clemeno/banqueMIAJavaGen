...
public class mvc_View__OwnedElementImpl_61152481 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__OwnedElementImpl_61152481() {
		//Do nothing
	}

	//For internal use only
	mvc_View__OwnedElementImpl_61152481(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"OwnedElementImpl", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''OwnedElementImpl''");
...
for (Model element : current.getModel().getOwnedElements()) {
	res += manager.getString(element, "OwnedElementImplView");
}
