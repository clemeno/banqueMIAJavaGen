package fr.alma.projet.generation.ui.controler.h1208499787;
...
public class mvc_View__InterfaceControler_Filename_381916491 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__InterfaceControler_Filename_381916491() {
		//Do nothing
	}

	//For internal use only
	mvc_View__InterfaceControler_Filename_381916491(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"InterfaceControler$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''InterfaceControler$Filename''");
...
_template_buffer.append("fr/alma/projet/generation/banque/ui/controler/I");
_template_buffer.append(manager.action(current, "ComputeModelName"));_template_buffer.append(".java");
