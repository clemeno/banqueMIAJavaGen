...
public class mvc_Model__OwnedElementAccessorsImpl_N1195166959 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__OwnedElementAccessorsImpl_N1195166959() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__OwnedElementAccessorsImpl_N1195166959(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"OwnedElementAccessorsImpl", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''OwnedElementAccessorsImpl''");
...
for(Model model : current.getOwnedElements()){
	res += manager.getString(model, "OwnedElementGetterImplTemplate");
	res += manager.getString(model, "OwnedElementSetterImplTemplate");
}
return res;
