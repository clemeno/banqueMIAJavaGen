...
public class mvc_View__ComputeAvailableActions_N1467881599 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__ComputeAvailableActions_N1467881599() {
		//Do nothing
	}

	//For internal use only
	mvc_View__ComputeAvailableActions_N1467881599(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ComputeAvailableActions", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ComputeAvailableActions''");
...
for(Action action : current.getActions()){
	res += manager.getString(action, "AvailableAction");
}
