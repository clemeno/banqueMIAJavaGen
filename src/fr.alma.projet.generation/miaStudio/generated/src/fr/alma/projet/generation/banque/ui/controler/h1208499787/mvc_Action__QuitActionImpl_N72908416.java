...
public class mvc_Action__QuitActionImpl_N72908416 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Action__QuitActionImpl_N72908416() {
		//Do nothing
	}

	//For internal use only
	mvc_Action__QuitActionImpl_N72908416(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"QuitActionImpl", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''QuitActionImpl''");
...
_template_buffer.append("	// Start of user code for quitter");
_template_buffer.append('\n');
_template_buffer.append("		//On veut fermer toutes les fenêtres ouvertes");
_template_buffer.append('\n');
_template_buffer.append("		Display.getCurrent().dispose();");
_template_buffer.append('\n');
_template_buffer.append("	// End of user code for quitter");
_template_buffer.append('\n');
_template_buffer.append("}");
_template_buffer.append('\n');
