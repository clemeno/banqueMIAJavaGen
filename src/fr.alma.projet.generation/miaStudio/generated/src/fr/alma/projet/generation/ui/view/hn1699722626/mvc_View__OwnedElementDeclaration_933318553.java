...
public class mvc_View__OwnedElementDeclaration_933318553 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__OwnedElementDeclaration_933318553() {
		//Do nothing
	}

	//For internal use only
	mvc_View__OwnedElementDeclaration_933318553(int anyInt, List anyList) {
...
for (Model elem : current.getModel().getOwnedElements()) {
	res += manager.getString(elem, "OwnedElementDeclarationView");
}
