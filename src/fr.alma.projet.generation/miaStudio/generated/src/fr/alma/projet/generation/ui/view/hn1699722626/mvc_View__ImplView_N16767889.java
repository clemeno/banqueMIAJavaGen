...
public class mvc_View__ImplView_N16767889 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__ImplView_N16767889() {
		//Do nothing
	}

	//For internal use only
	mvc_View__ImplView_N16767889(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ImplView", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ImplView''");
...
_template_buffer.append("package fr.alma.projet.generation.banque.ui.view.swt;");
...
_template_buffer.append(manager.action(current, "OwnedElementPackageImport"));_template_buffer.append('\n');
_template_buffer.append('\n');
...
_template_buffer.append('\n');
_template_buffer.append("	");
_template_buffer.append(manager.action(current, "ButtonsActionDeclaration"));_template_buffer.append('\n');
_template_buffer.append("	");
_template_buffer.append(manager.action(current, "OwnedElementDeclaration"));_template_buffer.append('\n');
_template_buffer.append("	");
_template_buffer.append('\n');
...
_template_buffer.append('\n');
_template_buffer.append("	");
_template_buffer.append(manager.action(current, "UnimplementedMethods"));_template_buffer.append('\n');
...
_template_buffer.append('\n');
_template_buffer.append("		");
_template_buffer.append(manager.action(current, "PropertyContent"));_template_buffer.append('\n');
_template_buffer.append("		");
_template_buffer.append(manager.action(current, "OwnedElementImpl"));_template_buffer.append('\n');
_template_buffer.append("		");
_template_buffer.append('\n');
...
_template_buffer.append('\n');
_template_buffer.append("		");
_template_buffer.append(manager.action(current, "ButtonActionImpl"));_template_buffer.append('\n');
_template_buffer.append("	}");
_template_buffer.append('\n');
_template_buffer.append("	");
_template_buffer.append('\n');
