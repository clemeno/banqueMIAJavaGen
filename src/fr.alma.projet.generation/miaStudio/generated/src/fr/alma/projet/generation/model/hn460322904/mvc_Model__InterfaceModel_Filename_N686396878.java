...
public class mvc_Model__InterfaceModel_Filename_N686396878 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__InterfaceModel_Filename_N686396878() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__InterfaceModel_Filename_N686396878(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"InterfaceModel$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''InterfaceModel$Filename''");
...
_template_buffer.append("fr/alma/projet/generation/banque/model/I");
