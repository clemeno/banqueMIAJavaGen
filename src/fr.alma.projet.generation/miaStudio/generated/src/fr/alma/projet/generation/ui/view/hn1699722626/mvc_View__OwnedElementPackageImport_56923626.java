...
public class mvc_View__OwnedElementPackageImport_56923626 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__OwnedElementPackageImport_56923626() {
		//Do nothing
	}

	//For internal use only
	mvc_View__OwnedElementPackageImport_56923626(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"OwnedElementPackageImport", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''OwnedElementPackageImport''");
...
for (Model element : current.getModel().getOwnedElements()) {
	res += manager.getString(element, "OwnedElementPackageImport");
}
