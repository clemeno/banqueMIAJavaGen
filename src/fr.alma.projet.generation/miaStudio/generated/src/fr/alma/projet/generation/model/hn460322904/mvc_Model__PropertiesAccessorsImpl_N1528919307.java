...
public class mvc_Model__PropertiesAccessorsImpl_N1528919307 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__PropertiesAccessorsImpl_N1528919307() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__PropertiesAccessorsImpl_N1528919307(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"PropertiesAccessorsImpl", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''PropertiesAccessorsImpl''");
...
String res = "";
	for(ModelProperty model : current.getProperties()){
		res += manager.getString(model, "PropertyGetterImplTemplate");
		res += manager.getString(model, "PropertySetterImplTemplate");
	}
return res;
