...
public class mvc_Model__OwnedElementSetterImplTemplate_N811847628 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__OwnedElementSetterImplTemplate_N811847628() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__OwnedElementSetterImplTemplate_N811847628(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"OwnedElementSetterImplTemplate", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''OwnedElementSetterImplTemplate''");
