...
public class mvc_Model__ModelDeclarationTemplate_1973859215 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__ModelDeclarationTemplate_1973859215() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__ModelDeclarationTemplate_1973859215(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ModelDeclarationTemplate", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ModelDeclarationTemplate''");
...
_template_buffer.append(manager.action(current, "name"));_template_buffer.append(" model;");
