...
public class mvc_Model__AttributeDeclaration_N1195036510 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__AttributeDeclaration_N1195036510() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__AttributeDeclaration_N1195036510(int anyInt, List anyList) {
...
for(ModelProperty model : current.getProperties()){
	res += manager.getString(model, "AttributeTemplate");
}
