...
public class mvc_View__UnimplementedMethods_N105898189 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__UnimplementedMethods_N105898189() {
		//Do nothing
	}

	//For internal use only
	mvc_View__UnimplementedMethods_N105898189(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"UnimplementedMethods", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''UnimplementedMethods''");
...
for (Action action : current.getActions()) {
	res += manager.getString(action, "UnimplementedMethod");
}
