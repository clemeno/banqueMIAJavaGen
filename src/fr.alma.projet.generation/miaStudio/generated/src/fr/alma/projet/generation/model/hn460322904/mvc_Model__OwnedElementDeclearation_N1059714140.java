...
public class mvc_Model__OwnedElementDeclearation_N1059714140 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__OwnedElementDeclearation_N1059714140() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__OwnedElementDeclearation_N1059714140(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"OwnedElementDeclearation", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''OwnedElementDeclearation''");
