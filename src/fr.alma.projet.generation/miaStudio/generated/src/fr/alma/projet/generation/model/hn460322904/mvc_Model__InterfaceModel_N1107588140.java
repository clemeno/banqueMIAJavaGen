...
_template_buffer.append(manager.action(current, "PropertiesAccessors"));_template_buffer.append('\n');
_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "OwnedElementAccessors"));_template_buffer.append('\n');
_template_buffer.append("}");
