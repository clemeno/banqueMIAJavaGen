...
public class mvc_Action__ActionTemplate_2022287659 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Action__ActionTemplate_2022287659() {
		//Do nothing
	}

	//For internal use only
	mvc_Action__ActionTemplate_2022287659(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ActionTemplate", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ActionTemplate''");
