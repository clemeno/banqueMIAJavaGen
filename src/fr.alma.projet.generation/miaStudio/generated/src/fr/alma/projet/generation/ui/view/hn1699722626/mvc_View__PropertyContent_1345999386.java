...
public class mvc_View__PropertyContent_1345999386 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__PropertyContent_1345999386() {
		//Do nothing
	}

	//For internal use only
	mvc_View__PropertyContent_1345999386(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"PropertyContent", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''PropertyContent''");
...
for (ModelProperty property : current.getModel().getProperties()) {
	res += manager.getString(property, "PropertyContent");
}
