...
public class mvc_View__ComputeModelName_N819655577 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__ComputeModelName_N819655577() {
		//Do nothing
	}

	//For internal use only
	mvc_View__ComputeModelName_N819655577(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ComputeModelName", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ComputeModelName''");
