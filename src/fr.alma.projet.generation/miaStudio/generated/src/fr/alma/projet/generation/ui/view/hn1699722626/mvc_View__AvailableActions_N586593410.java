...
public class mvc_View__AvailableActions_N586593410 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__AvailableActions_N586593410() {
		//Do nothing
	}

	//For internal use only
	mvc_View__AvailableActions_N586593410(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"AvailableActions", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''AvailableActions''");
...
for (Action action : current.getActions()) {
	res += manager.getString(action, "ActionDeclaration");
}
