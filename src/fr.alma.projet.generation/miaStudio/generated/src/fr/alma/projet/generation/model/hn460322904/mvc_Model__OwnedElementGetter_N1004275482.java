...
public class mvc_Model__OwnedElementGetter_N1004275482 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__OwnedElementGetter_N1004275482() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__OwnedElementGetter_N1004275482(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"OwnedElementGetter", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''OwnedElementGetter''");
...
for(Model model : current.getOwnedElements()){
	res = manager.getString(model, "GetterTemplate");
}
return res;
