...
public class mvc_View__InterfaceView_Filename_743098322 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__InterfaceView_Filename_743098322() {
		//Do nothing
	}

	//For internal use only
	mvc_View__InterfaceView_Filename_743098322(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"InterfaceView$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''InterfaceView$Filename''");
...
_template_buffer.append("fr/alma/projet/generation/banque/ui/view/I");
