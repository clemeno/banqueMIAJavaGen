...
public class mvc_Model__ImportModelPackage_N1544758906 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__ImportModelPackage_N1544758906() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__ImportModelPackage_N1544758906(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ImportModelPackage", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ImportModelPackage''");
...
_template_buffer.append("import fr.alma.projet.generation.model.");
