...
public class mvc_View__ButtonsActionDeclaration_1643766637 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__ButtonsActionDeclaration_1643766637() {
		//Do nothing
	}

	//For internal use only
	mvc_View__ButtonsActionDeclaration_1643766637(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ButtonsActionDeclaration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ButtonsActionDeclaration''");
...
for (Action action : current.getActions()) {
	res += manager.getString(action, "ButtonActionDeclaration");
}
