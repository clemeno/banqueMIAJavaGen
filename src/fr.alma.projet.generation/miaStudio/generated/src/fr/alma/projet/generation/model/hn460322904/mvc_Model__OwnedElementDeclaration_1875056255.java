...
public class mvc_Model__OwnedElementDeclaration_1875056255 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__OwnedElementDeclaration_1875056255() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__OwnedElementDeclaration_1875056255(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"OwnedElementDeclaration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''OwnedElementDeclaration''");
...
for (Model model : current.getOwnedElements()) {
	res += manager.getString(model, "OwnedElementAsAttributeTemplate");
}
