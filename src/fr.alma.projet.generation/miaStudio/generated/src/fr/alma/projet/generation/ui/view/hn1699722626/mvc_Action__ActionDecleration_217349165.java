...
public class mvc_Action__ActionDecleration_217349165 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Action__ActionDecleration_217349165() {
		//Do nothing
	}

	//For internal use only
	mvc_Action__ActionDecleration_217349165(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ActionDecleration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ActionDecleration''");
