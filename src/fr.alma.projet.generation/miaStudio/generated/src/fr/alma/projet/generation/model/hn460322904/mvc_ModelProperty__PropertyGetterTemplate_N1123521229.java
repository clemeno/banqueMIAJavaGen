...
public class mvc_ModelProperty__PropertyGetterTemplate_N1123521229 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_ModelProperty__PropertyGetterTemplate_N1123521229() {
		//Do nothing
	}

	//For internal use only
	mvc_ModelProperty__PropertyGetterTemplate_N1123521229(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"PropertyGetterTemplate", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''PropertyGetterTemplate''");
