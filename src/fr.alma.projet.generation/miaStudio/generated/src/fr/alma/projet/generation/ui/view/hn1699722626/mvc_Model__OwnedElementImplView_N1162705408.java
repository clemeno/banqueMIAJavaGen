...
public class mvc_Model__OwnedElementImplView_N1162705408 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__OwnedElementImplView_N1162705408() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__OwnedElementImplView_N1162705408(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"OwnedElementImplView", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''OwnedElementImplView''");
...
_template_buffer.append(manager.action(current, "name"));_template_buffer.append("List = new List(grp");
_template_buffer.append(manager.action(current, "name"));_template_buffer.append(", SWT.BORDER | SWT.V_SCROLL | SWT.SINGLE);");
_template_buffer.append('\n');
_template_buffer.append("		this.");
_template_buffer.append(manager.action(current, "name"));_template_buffer.append("List.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));");
_template_buffer.append('\n');
_template_buffer.append("		");
_template_buffer.append('\n');
...
_template_buffer.append('\n');
_template_buffer.append("			this.");
_template_buffer.append(manager.action(current, "name"));_template_buffer.append("List.add(elt.toString());");
_template_buffer.append('\n');
_template_buffer.append("		}");
_template_buffer.append('\n');
_template_buffer.append("	");
