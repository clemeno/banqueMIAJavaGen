...
public class mvc_Model__ComputeDependencies_1950649116 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__ComputeDependencies_1950649116() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__ComputeDependencies_1950649116(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ComputeDependencies", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ComputeDependencies''");
...
for(Model model : current.getOwnedElements()){
	res += manager.getString(model, "ImportModelPackageTemplate");
}
return res;
