...
public class mvc_View__InterfaceView_1241078324 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__InterfaceView_1241078324() {
		//Do nothing
	}

	//For internal use only
	mvc_View__InterfaceView_1241078324(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"InterfaceView", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''InterfaceView''");
...
_template_buffer.append("package fr.alma.projet.generation.banque.ui.view;");
...
_template_buffer.append(manager.action(current, "AvailableActions"));_template_buffer.append('\n');
_template_buffer.append("}");
