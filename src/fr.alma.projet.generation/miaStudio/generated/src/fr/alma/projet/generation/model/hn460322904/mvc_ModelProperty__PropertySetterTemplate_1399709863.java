...
public class mvc_ModelProperty__PropertySetterTemplate_1399709863 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_ModelProperty__PropertySetterTemplate_1399709863() {
		//Do nothing
	}

	//For internal use only
	mvc_ModelProperty__PropertySetterTemplate_1399709863(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"PropertySetterTemplate", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''PropertySetterTemplate''");
