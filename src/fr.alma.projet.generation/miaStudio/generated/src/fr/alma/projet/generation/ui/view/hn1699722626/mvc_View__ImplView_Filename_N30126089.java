...
public class mvc_View__ImplView_Filename_N30126089 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__ImplView_Filename_N30126089() {
		//Do nothing
	}

	//For internal use only
	mvc_View__ImplView_Filename_N30126089(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ImplView$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ImplView$Filename''");
...
_template_buffer.append("fr/alma/projet/generation/banque/ui/view/swt/");
