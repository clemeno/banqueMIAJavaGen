...
public class mvc_View__AttributeDeclaration_1045765576 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__AttributeDeclaration_1045765576() {
		//Do nothing
	}

	//For internal use only
	mvc_View__AttributeDeclaration_1045765576(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"AttributeDeclaration", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''AttributeDeclaration''");
...
res += manager.getString(current, "ViewDeclarationTemplate");
res += manager.getString(current.getModel(), "ModelDeclarationTemplate");
